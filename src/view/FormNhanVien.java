...
public class FormNhanVien extends javax.swing.JPanel {
    ...
    public FormNhanVien() {
        initComponents();
        setSize(900,700);
        String[] cols={"Mã nhân viên","Tên nhân viên","Chức vụ", "Mã chi nhánh", "Account","Passwword"};
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên", "Thu Ngân", "Bảo vệ" }));
...
//        jTextField1.setText(NhanVien.getSma()+"");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            s.setMaCN(Integer.parseInt(jTextField3.getText()));
            s.setTenDN(jTextField4.getText());
            s.setMatKhau(jTextField5.getText());
...
//            s.setSl(Integer.parseInt(jTextField5.getText()));
        ...
        if(sua){
            ...
            tm.setValueAt(Integer.parseInt(jTextField3.getText()),r, 3);
