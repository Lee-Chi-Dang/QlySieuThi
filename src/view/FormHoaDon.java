...
public class FormHoaDon extends javax.swing.JPanel {
    ...
    public FormHoaDon() {
        initComponents();
        setSize(900,700);
        String[] cols={"Mã hóa đơn","Mã nhân viên","Mã khách hàng", "Ngày tạo", "Ghi chú"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        them=false;sua=false;
        file = "src/Controller/HD.DAT";
        buttonTrue();
    }
...
//        if(f.exists()){
//            List<HoaDon> list=IOFile.docra(file);
//            if(list.size()>0){
//                HoaDon.setSma(list.get(list.size()-1).getMa()+1);
//                
//            }
//        }
...
//            s.setChucVu(jComboBox1.getSelectedItem().toString());
            ...
            s.setMaNV(Integer.parseInt(jTextField2.getText()));
            s.setMaKH(Integer.parseInt(jTextField3.getText()));
            s.setNgayTao(jTextField4.getText());
            s.setGhiChu(jTextField5.getText());
...
//            s.setSl(Integer.parseInt(jTextField5.getText()));
        ...
        if(sua){
            ...
            tm.setValueAt(Integer.parseInt(jTextField2.getText()),r, 0);
            ...
            tm.setValueAt(jTextField5.getText(),r, 4);
            buttonTrue();
            sua=false;
        }
