 ...
 * @author ADMIN
 */
public class FormChiNhanh extends javax.swing.JPanel {
    ...
    public FormChiNhanh() {
        initComponents();
        setSize(900,700);
        String[] cols={"Mã chi nhánh","Tên chi nhánh",
            "Địa chỉ"};
...
//        if(f.exists()){
//           List<ChiNhanh> list=IOFile.docra(file);
//            if(list.size()>0){
//                ChiNhanh.setSma(list.get(list.size()-1).getMa()+1);                
//            }
//        }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            b.setTenCN(jTextField2.getText());
